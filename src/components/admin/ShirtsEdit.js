...
function ShirtEdit({ showModal, closeModal, itemToEdit, handleSave }) {
    ...
    <>
      <Modal show={showModal} onHide={closeModal} size="lg" centered>
        <Modal.Header closeButton>
          <Modal.Title>Edit Shirt</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          {editedItem && (
            <Form>
              <Form.Group controlId="formShirtName" className="mb-4">
                ...
                <Form.Control
                  ...
                  placeholder="Enter the shirt name"
                  style={{ borderRadius: "0" }}
                />
              </Form.Group>
              <Form.Group controlId="formShirtPrice" className="mb-4">
              ...
              <Form.Group controlId="formShirtQuantity" className="mb-4">
              ...
              <Form.Group controlId="formShirtColors" className="mb-4">
              ...
              <Form.Group controlId="formShirtSizes" className="mb-4">
