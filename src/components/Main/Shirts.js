  ...
  const toggleCartModal = () => {
    if (!isCartModalOpen) {
      ...
      for (let i = 0; i < numberOfItemsToAdd; i++) {
        const randomIndex = Math.floor(Math.random() * shirtsData.length);
        const randomItem = shirtsData[randomIndex];
  ...
  return (
    <div id="mens-latest" className="mens-latest mt-5">
      <Container fluid className="px-3 px-md-5 mb-5">
        <h1 className="mb-5" style={{fontSize: 26, fontWeight: 400}} >Discover your ideal shirts</h1> 
